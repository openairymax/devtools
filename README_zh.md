# Airymax Tools — 开发工具与配置中心

> Airymax 项目统一开发工具与配置中心

**语言:** [English](README.md) | 简体中文

[![Version](https://img.shields.io/badge/version-0.1.5-5a6b7e)](https://atomgit.com/openairymax/tools)
...
Tools 是 Airymax 38 仓拆分方案中的 4 个顶层仓之一（另三个为 docs、closed-docs 和 closed-dev-build；v0.1.4 由 devtools 改名），集中管理全项目共用的开发工具配置、代码规范和构建工具链。所有 38 仓共享此处的配置文件，确保跨仓库一致的代码风格和质量标准。
...
各仓库通过 `tools/` submodule 路径引用配置文件：
...
| **下游** | 所有 38 仓均通过 submodule 引用 tools 配置 |

## 仓库信息

- **仓库 URL**: `git@atomgit.com:openairymax/tools.git`
- **归属组织**: openairymax
- **分支策略**: 仅 `main` 分支
