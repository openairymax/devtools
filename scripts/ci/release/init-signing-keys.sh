...
echo "  cosign verify-blob --key keys/cosign.pub --signature agentrt-v0.1.5-linux-x86_64.tar.gz.sig \\"
echo "      --insecure-ignore-tlog agentrt-v0.1.5-linux-x86_64.tar.gz"
